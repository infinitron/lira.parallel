...
def gof_cstat(miu,obs):
    ...
    for i in range(np.size(miu)):
        if miu[i]==0:
            ...
            ce[i]=-0.25*miu[i]**3+1.38*miu[i]**2-2*miu[i]*np.log(miu[i])
        elif 0.5 < miu[i] and miu[i]<=2:
            ce[i]=-0.00335*miu[i]**5 + 0.04259*miu[i]**4 - 0.27331*miu[i]**3 + 1.381*miu[i]**2 - 2*miu[i]*np.log(miu[i])
    ...
    for i in range(np.size(miu)):
        if  0<= miu[i] and miu[i]<= 0.1:
            cv[i]=4*sum(np.exp(-miu[i])*miu[i]**k/factorial(k)*(miu[i]-k+k*np.log(k/miu[i]))**2)+4*(np.exp(-miu[i])*miu[i]**0/factorial(0)*(miu[i])**2)-ce[i]**2
        elif 0.1 < miu[i] and miu[i]<= 0.2:
            cv[i]=-262*miu[i]**4+195*miu[i]**3-51.24*miu[i]**2+4.34*miu[i]+0.77005
            ...
            cv[i]=1.28*miu[i]**4-5.191*miu[i]**3+7.666*miu[i]**2-3.5446*miu[i]+1.15431
        elif 1 < miu[i] and miu[i]<= 2:
            cv[i]=0.1125*miu[i]**4-0.641*miu[i]**3+0.859*miu[i]**2+1.0914*miu[i]-0.05748
        elif 2 < miu[i] and miu[i]<= 3:
            cv[i]=0.089*miu[i]**3-0.872*miu[i]**2+2.8422*miu[i]-0.67539
