...
=======
Python helper scripts to prepare inputs are located in the [input_prep](https://github.com/infinitron/lira.parallel/tree/master/input_prep/) folder. These helper scripts are tailored for use with *Chandra* observations.
>>>>>>> Stashed changes
